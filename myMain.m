...
for iSubj=1:para.nsubject
    ...
    dlmwrite('eeg_raw.csv', fEEGDataCl1, 'delimiter', ',', 'precision', 16); 
    ...
    for iFold = 1:nFold        
        ...
        fXTrainCL1(idx1,:)=[];                           %Remove 1 fold %lzq: delete the data relate to subject i.
        fYTrainCL1 = fYLabelCL1;
        fYTrainCL1(idx1)=[];                             %Remove 1 fold %lzq: delete the sleepiness result for subject i.
